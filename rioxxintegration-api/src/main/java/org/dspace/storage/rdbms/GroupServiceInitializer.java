...
import com.atmire.authorization.checks.GroupAuthorizationInitializer;
...
public class GroupServiceInitializer implements FlywayCallback {
    ...
    public void initGroups() {
        ...
        try
        {
            ...
            GroupAuthorizationInitializer groupAuthorizationInitializer = DSpaceServicesFactory.getInstance().getServiceManager().getServiceByName("com.atmire.authorization.checks.GroupAuthorizationInitializer", GroupAuthorizationInitializer.class);
            groupAuthorizationInitializer.afterMigrate(context);
