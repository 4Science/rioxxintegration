...
public class DSpaceAuthorityIndexer implements AuthorityIndexerInterface, InitializingBean {
	...
	public List<AuthorityValue> getAuthorityValues(Context context) throws SQLException, AuthorizeException {
		List<AuthorityValue> toIndexValues = new ArrayList<AuthorityValue>();
        ...
        while (allItems.hasNext()) {
            ...
            List<AuthorityValue> authorityValues = getAuthorityValues(context, item, authorityCache);
            for (AuthorityValue authorityValue : authorityValues) {
                toIndexValues.add(authorityValue);
            }
